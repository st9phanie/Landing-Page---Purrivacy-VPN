      ...
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        ...
        >
          ...
          <Paragraph className="mt-8">
            PurrivacyVPN keeps your data encrypted, location hidden, and trackers declawed. With lightning-fast speeds, 
            a no-logs policy, and servers in over 60 countries, we’re the purr-fect blend of security and simplicity. 
          </Paragraph>
            ...
            <div className="flex sm:flex-row flex-col gap-5 w-full">
              <form
                ...
                className="py-1 pl-6 w-full pr-1 flex gap-3 items-center text-heading-3
                                          shadow-lg shadow-box-shadow border border-violet-900
        ...
        <div className="flex flex-1 lg:w-1/2 lg:h-auto relative lg:max-w-none lg:mx-0 mx-auto max-w-3xl">
          <img
            src="
            https://www.shutterstock.com/image-photo/metaverse-vpn-cybersecurity-cybercrime-internet-600nw-2135121637.jpg
